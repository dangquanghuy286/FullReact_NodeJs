...
const ChatWelcomeScreen = () => {
  ...
  <span className="text-3xl">☀️</span>
          ...
          <h2 className="text-2xl font-bold mb-2 bg-gradient-chat bg-clip-text text-transparent">Welcome to Chat</h2>
          <p className="text-sm text-muted-foreground">Start a new conversation or select an existing one to get started.</p>
        </div>
      </div>
